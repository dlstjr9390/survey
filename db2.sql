...
-- 테이블 데이터 yis.comment:~22 rows (대략적) 내보내기
...
-- 테이블 데이터 yis.survey_auth:~3 rows (대략적) 내보내기
...
-- 테이블 데이터 yis.survey_question:~32 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `survey_user` (
  ...
  `u_name` varchar(50) DEFAULT NULL,
  `u_datetime` datetime DEFAULT current_timestamp(),
  `u_isAccountNonExpired` int(11) DEFAULT NULL,
  `u_isAccountNonLocked` int(11) DEFAULT NULL,
  `u_isCredentialsNonExpired` int(11) DEFAULT NULL,
  `u_isEnabled` int(11) DEFAULT NULL,
  PRIMARY KEY (`u_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4;

-- 테이블 데이터 yis.survey_user:~3 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `u_auth` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`u_idx`)
...
INSERT INTO `user` (`u_idx`, `u_id`, `u_pw`, `u_name`, `u_tel`, `u_age`, `u_auth`) VALUES
	(1, 'aaa', '1234', '학생1', '010-1234-1234', '99', 1),
	(2, 'dls', '1234', '학생2', '010-101-010', '121', 1),
	(3, 'asdgasdg', 'asdgasdg', '학생3', '6416-1616-6516', '15', 1),
	(4, 'aaafff', '165165', '학생4', '888-888-8888', '88', 0),
	(5, 'qqqqqqq', '88897898', '학생5', '7777-7777-7777', '77', 0),
	(6, 'bbbbbbb', '66666', '학생6', '2222-2222-2222', '22', 0),
	(7, 'ghhyhyhyh', '74456654', '학생7', '1651-1615-161', '6', 0),
	(8, 'qewrqewr', '74456654', '학생8', '1651-4111-161', '66', 0),
	(9, 'kkkkkkkkkkkkkk', '1234', '학생9', '4848-4848-8484', '48', 0),
	(10, 'pppppppppppppppp', '1234', '학생10', '4848-4848-8484', '48', 0),
	(11, 'p', '1234', '학생11', '4848-4848-8484', '48', 0),
	(12, 'pqwe', '1234', '학생12', '4848-4848-8484', '48', 0),
	(13, 'pqwewerw', '1234', '학생13', '4848-4848-8484', '48', 0),
	(14, 'pqwewerwaa', '1234a', '학생14', '1111-4848-8484', '15', 0),
	(15, 'mmmnnn', '1234a', '학생15', '1111-4848-8484', '15', 0),
	(16, 'lkkjjhhg', '1234a', '학생16', '1111-4746-8484', '15', 0),
	(18, 'fqfqfqf', '65146541651', '추가', '9877-4894-4984', '98', 0),
	(19, 'mmmmmmmmmmmmm', '65146541651', '추가2', '9877-4894-4984', '77', 0),
	(20, 'fffffffffffffffffffffffffffff', '65146541651', '추가3', '9877-4894-4984', '77', 0),
	(21, 'sdagqgqgqg', 'fasfd', '추가3', '9494-9849-9849', '9', 0),
	(22, 'sdagqgqgqg', 'fasfd', '추가4', '9494-9849-9849', '11', 0),
	(23, 'sdagqgqgqg', 'fasfd', '추가5', '9494-9849-9849', '145', 0),
	(24, 'sdagqgqgqgaaa', 'fasfda', '추가6', '9494-9849-9849', '145', 0),
	(25, 'sdagqgqgqgaaa111', 'fasfda', '추가7', '9494-9849-9849', '145', 0),
	(26, '124141414', 'fasfda', '추가8', '9494-9849-9849', '1', 0),
	(27, '1a11a1a1a', 'fasfda', '추가9', '9494-9849-9849', '12', 0),
	(28, 'dfafafafafaf', 'fasfda', '추가10', '9494-9849-9849', '33', 0),
	(29, 'fzzzz', 'fasfda', '추가11', '9494-9849-9849', '33', 0),
	(30, 'fqqqq', 'fasfda', '추가12', '9494-9849-9849', '33', 0),
	(31, 'zxczc', 'fasfda', '추가13', '8989-9849-9849', '33', 0),
	(32, 'qq', 'fasfda', '추가14', '8998-9849-9849', '33', 0),
	(33, 'qq1414', 'fasfda', '추가15', '8998-9849-9849', '33', 0);
